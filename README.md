...
- As rotas ligadas a usuários foram feitas sem autenticação ou sistema de roles para adição/remoção de clientes; O motivo é tornar mais fácil a validação do que foi feito.
